...
- [x] 과거 데이터 조회 제한 날짜 2026-06-03으로 변경
- [x] 대량 데이터 삽입용 bulk insert 스크립트(`import_csv_to_db.py`) 작성
- [x] 기존 패턴 기반 과거 가상 데이터 생성 스크립트(`generate_mock_*.py`) 작성 및 4개 기기 전체(ESP_NODE_01~04)의 5.28~6.3 과거 데이터(약 18,000건) 준비 완료
- [ ] ESP32 클라이언트 연동 코드 작성

---
*마지막 업데이트: 2026-06-05 (과거 데이터 조회 제한 06-03으로 변경)*
